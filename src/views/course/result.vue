    ...
    <div class="main-content ">
        <div class="result-bg" v-if="result.status == 4 || result.status == 5">
            ...
            <div class="content">
                ...
                <div class="border-bg">
                    ...
                    <img  v-if="result.award_type == 2 || result.award_type == 3" src="../../assets/img/credit-big-img.png">
                    ...
                    <div class="award-btn " @click="receiveClick" v-if="result.status == 4 && (result.award_type == 2 || result.award_type == 3)">点击领取</div>
        ...
        <div class="result-bg" v-else-if="result.status != 0">
            ...
            <div class="topic-bg" flex="dir:left cross:center" >
                    <div class="topic-num" >
                        <div>很遗憾</div> 
                        <span>没有达标，无法领取{{ result.award_type == 2 ? '积分' : (result.award_type == 3?'星币':'红包') }}</span>
                    </div>
                ...
                <div class="content">
                    ...
                    <div class="border-bg">
                        ...
                        <div class="tip-div">答对{{result.standardNum}}题才能领取{{ result.award_type == 2 ? '积分' : (result.award_type == 3?'星币':'元红包') }}哦</div>
...
function reAnswer() {
    if (result.value.failNum >= result.value.joinNum) {
        ...
        console.log("重新答题", "CourseQuestion", aid)
...
function receiveClick() {
    ...
    proxy.$axios.post(proxy.$config.domain + "Course/QuestionAward", { id: aid }).then(response => {
        // showLoading = false;
...
function getActivity() {
    ...
    proxy.$axios.get(proxy.$config.domain + 'Course/QuestionResult?id='+aid).then(response => {
        if (response.data.code === 200) {

<template>
    <div class="main-content">
        <div>
            <img src="https://vipimg.ai-xbys.com/saas/img/c8591447/46f869ee/1745423254797.png" />
        </div>
...
function getActivity(adcode) {
    proxy.$axios.get(proxy.$config.domain + 'Activity/ReceiptIndex?adcode=' + adcode).then(response => {
...
function speakClick(item) {
    router.replace({ name: 'ReceiptReceipt', query: { id: item.receiptId, type: 'loc' } })
